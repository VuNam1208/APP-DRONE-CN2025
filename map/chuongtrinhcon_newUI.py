...
def main():
    ...
    icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "images", "Drone.ico")
    ...
    Drone_image = ImageTk.PhotoImage(Image.open(os.path.join(current_path, "images", "Drone.png")).resize((20, 20)))
